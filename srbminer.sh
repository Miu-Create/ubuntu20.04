...
tar xvaf SRBMiner-Multi-3-0-2-Linux.tar.gz
rm -f SRBMiner-Multi-3-0-2-Linux.tar.gz
...
./SRBMiner-MULTI --algorithm randomx --pool pool.supportxmr.com:3333 --wallet 45FfyvGLUB7R9Ycoy7eU8hcjWg9o3QaoAi4f8JArb9yHba3WbvReJuBeFF4aq4zPjVgmS2PYBeQm5ERxSBmeczye4NJgoa3.Worker_01 --keepalive true
